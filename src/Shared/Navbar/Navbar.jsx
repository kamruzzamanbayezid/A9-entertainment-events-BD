...
const Navbar = () => {
      ...
      return (
            <div className="bg-[#0D1128]">
                  <nav className="max-w-7xl mx-auto py-3 lg:py-4">
                        <div className="flex p-2 lg:p-0 flex-col md:flex-row gap-3 md:gap-0 justify-between items-center">
                              <div>
                                    ...
                                    <div className="dropdown lg:hidden">
                                          <label tabIndex={0} className="text-[#FFF] md:m-1"><HiOutlineMenu className="text-3xl"></HiOutlineMenu></label>
