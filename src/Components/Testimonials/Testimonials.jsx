...
const Testimonials = () => {
      ...
      return (
            <div className="grid bg-[#0D1128] px-16 py-20 grid-cols-1 md:grid-cols-2 gap-6 lg:grid-cols-3 mb-10">
                  {
                              ...
                              return <div key={testimonial.id}>
                                    <div className="my-8">
                                          ...
                                          <div className="relative bg-[#FFFFFF] pt-24 px-5 pb-5">
                                                ...
                                                <img className="w-40 absolute -top-14 border-[5px] border-[#0D1128] left-[55px] lg:left-[105px] md:left-[70px]" src={testimonial.image} alt="Author image" />
                                          </div>
